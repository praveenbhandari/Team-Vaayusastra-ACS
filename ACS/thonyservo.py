...
while True:
    ...
    if circles is not None and ():
        ...
        for (x, y, r) in circles:
            ...
            a = f'Radius is {r}'
            b = f'Center is ({x},{y})'
            red_circle = cv2.putText(output, b, (x - 5 + 80, y - 5 + 120), cv2.FONT_HERSHEY_COMPLEX, 0.7,(255, 255, 255), 4)
            print(red_circle)
...
# ///////////////////////////////////////////////////////////////
        '''if x>0 and y>0 and x>int(frame.shape[1] / 2)+30 and y>int(frame.shape[0]/2)+30 and x<int(frame.shape[1] / 2)+100and y<int(frame.shape[0]/2)+100:
